(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var ErrorHomeComponent = /** @class */ (function () {
                function ErrorHomeComponent(route) {
                    this.route = route;
                    this.errorMsg = this.route.snapshot.paramMap.get("errorMsg");
                }
                ErrorHomeComponent.prototype.ngOnInit = function () {
                };
                return ErrorHomeComponent;
            }());
            ErrorHomeComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FileDownloadHomeComponent = /** @class */ (function () {
                function FileDownloadHomeComponent(toastr) {
                    var _this = this;
                    this.toastr = toastr;
                    jquery__WEBPACK_IMPORTED_MODULE_3___default()(document).ready(function () { return _this.onLinkElementChange(null); });
                }
                FileDownloadHomeComponent.prototype.ngOnInit = function () {
                };
                FileDownloadHomeComponent.prototype.onLinkElementChange = function (event) {
                    console.log("calling shrinktofill");
                    this.shrinkToFill("#link-input", 25, "", "serif");
                };
                FileDownloadHomeComponent.prototype.clickClipboardIcon = function () {
                    this.copyToClipboard(this.fileDownloadLink);
                };
                FileDownloadHomeComponent.prototype.copyToClipboard = function (item) {
                ...
                FileDownloadHomeComponent.prototype.measureText = function (txt, font) {
                ...
                FileDownloadHomeComponent.prototype.shrinkToFill = function (input, fontSize, fontWeight, fontFamily) {
                ...
                return FileDownloadHomeComponent;
            }());
            FileDownloadHomeComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FileInputComponent = /** @class */ (function () {
                function FileInputComponent(location) {
                ...
                FileInputComponent.prototype.uploadFile = function () {
                    var _this = this;
                    this.state = "loading";
                    // setTimeout(() => {
                    //   console.log("got");
                    ...
                    xhr.onload = function () {
                        if (xhr.status === 200) {
                            ...
                            if (responseText == "error") {
                                _this.state = "error";
                                _this.fileDownloadLink = "error";
                                _this.errorMsg = _this.defaultErrorMsg;
                            }
                            else {
                                _this.state = "loaded";
                                _this.fileDownloadLink = responseText;
                                _this.errorMsg = _this.defaultErrorMsg;
                            }
                        }
                        else {
                ...
                FileInputComponent.prototype.uploadFileChange = function () {
                    var file = document.getElementById('myfile').files[0];
                    if (!file) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var UploadErrorMsgComponent = /** @class */ (function () {
                function UploadErrorMsgComponent() {
                }
                UploadErrorMsgComponent.prototype.ngOnInit = function () {
                };
                return UploadErrorMsgComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
